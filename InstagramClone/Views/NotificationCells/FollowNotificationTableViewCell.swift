...
class FollowNotificationTableViewCell: UITableViewCell {
   ...
   static let identifier = "FollowNotificationTableViewCell"
    ...
    @objc func didTapFollowButton() {
        ...
        delegate?.followNotificationTableViewCellDidTapButton(self, didTapButton: !isFollowing, viewModel: vm)
    ...
    private func updateButton() {
        ...
        followButton.backgroundColor = isFollowing ? .secondarySystemBackground : .systemBlue
    ...
    override func layoutSubviews() {
        ...
        followButton.frame = CGRect(x: contentView.width - buttonWidth - 24, y: (contentView.height - followButton.height) / 2, width: followButton.width + 14, height: followButton.height)
